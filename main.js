const field = document.querySelector('#add-input')
console.log(field)
...
// numbersAndOperators is a reference to a class for all numbers and operators except clear and =

// equalButton.addEventListener('click', function(event) {
//     let answer = eval(disMath; display.textcontent = answer;)
// })
